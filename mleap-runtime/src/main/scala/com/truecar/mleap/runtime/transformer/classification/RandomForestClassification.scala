...
import com.truecar.mleap.core.classification.RandomForestClassificationModel
...
/**
  ...
  */
case class RandomForestClassification(uid: String = Transformer.uniqueName("random_forest_classification"),
                                      featuresCol: String,
                                      predictionCol: String,
                                      model: RandomForestClassificationModel) extends Transformer {
